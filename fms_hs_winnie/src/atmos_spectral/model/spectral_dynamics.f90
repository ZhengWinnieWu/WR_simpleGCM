...
character(len=128), parameter :: version = '$Id: spectral_dynamics.F90,v 17.0.6.1 2010/09/03 13:39:55 pjp Exp $'
...
subroutine spectral_dynamics(Time, psg_final, ug_final, vg_final, tg_final, vorg_final, tracer_attributes, grid_tracers_final, &
...
real, intent(out), dimension(is:, js:, :   ) :: ug_final, vg_final, tg_final, vorg_final
